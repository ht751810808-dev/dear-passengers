...
const sets = [
  ['/', '/de/', '/zh-cn/', '/ar/', '/tr/', '/pt-br/', '/es/', '/my/', '/ru/', '/cs/'],
  ['/game-dear-passengers/', '/de/dear-passengers-spiel/', '/zh-cn/dear-passengers-game/', '/ar/dear-passengers-game/', '/tr/dear-passengers-oyunu/', '/pt-br/jogo-dear-passengers/', '/es/juego-dear-passengers/', '/ru/igra-dear-passengers/', '/cs/hra-dear-passengers/'],
  ['/dear-passengers-gameplay/', '/de/dear-passengers-gameplay/', '/ar/dear-passengers-gameplay/', '/tr/dear-passengers-oynanis/', '/pt-br/dear-passengers-como-jogar/', '/es/dear-passengers-como-jugar/', '/my/dear-passengers-gameplay/', '/ru/dear-passengers-kak-igrat/', '/cs/dear-passengers-jak-hrat/'],
  ...
  ['/dear-passengers-download/', '/de/dear-passengers-download/', '/zh-cn/dear-passengers-download/', '/ar/dear-passengers-download/', '/tr/dear-passengers-indir/', '/pt-br/dear-passengers-baixar/', '/es/dear-passengers-descargar/', '/my/dear-passengers-download/', '/ru/dear-passengers-skachat/', '/cs/dear-passengers-stahnout/'],
  ['/dear-passengers-ps5/', '/de/dear-passengers-ps5/', '/tr/dear-passengers-ps5/'],
  ...
  ['/dear-passengers-system-requirements/', '/de/dear-passengers-systemanforderungen/', '/zh-cn/dear-passengers-system-requirements/', '/ar/dear-passengers-system-requirements/', '/tr/dear-passengers-sistem-gereksinimleri/', '/pt-br/dear-passengers-requisitos/', '/es/dear-passengers-requisitos/', '/my/dear-passengers-system-requirements/', '/ru/dear-passengers-sistemnye-trebovaniya/', '/cs/dear-passengers-systemove-pozadavky/'],
