...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/games-like-dear-passengers/', languages: { en: '/games-like-dear-passengers/', ar: '/ar/games-like-dear-passengers/', de: '/de/spiele-wie-dear-passengers/', 'x-default': '/games-like-dear-passengers/' } },
  openGraph: {
