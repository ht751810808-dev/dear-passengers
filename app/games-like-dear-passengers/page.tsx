...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/games-like-dear-passengers/', languages: { en: '/games-like-dear-passengers/', ar: '/ar/games-like-dear-passengers/', de: '/de/spiele-wie-dear-passengers/', tr: '/tr/dear-passengers-benzeri-oyunlar/', 'x-default': '/games-like-dear-passengers/' } },
  openGraph: {
