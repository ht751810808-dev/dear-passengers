...
export const metadata: Metadata = { title: { absolute: 'تواصل مع DearPassengers.net وأرسل تصحيحاً' }, description: 'أرسل تصحيحاً أو مصدراً أو ملاحظة عن النسخة العربية المستقلة من دليل Dear Passengers.', alternates: { canonical: '/ar/contact/', languages: { en: '/contact/', ar: '/ar/contact/', de: '/de/kontakt/', 'x-default': '/contact/' } } };
