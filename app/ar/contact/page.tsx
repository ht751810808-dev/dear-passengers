...
export const metadata: Metadata = { title: { absolute: 'تواصل مع DearPassengers.net وأرسل تصحيحاً' }, description: 'أرسل تصحيحاً أو مصدراً أو ملاحظة عن النسخة العربية المستقلة من دليل Dear Passengers.', alternates: { canonical: '/ar/contact/', languages: { en: '/contact/', ar: '/ar/contact/', de: '/de/kontakt/', tr: '/tr/iletisim/', 'pt-BR': '/pt-br/contato/', es: '/es/contacto/', 'my-MM': '/my/contact/', 'x-default': '/contact/' } } };
