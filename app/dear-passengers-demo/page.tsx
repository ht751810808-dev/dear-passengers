...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/dear-passengers-demo', languages: { en: '/dear-passengers-demo/', ar: '/ar/dear-passengers-demo/', de: '/de/dear-passengers-demo/', 'x-default': '/dear-passengers-demo/' } },
  openGraph: {
