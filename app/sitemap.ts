...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    ...arabicPaths.map((path) => ({ url: `${baseUrl}${path}`, lastModified: new Date(path === '/ar/dear-passengers-news/' ? '2026-09-02' : path === '/ar/dear-passengers-demo/' ? '2026-09-18' : path === '/ar/' ? '2026-07-29' : '2026-07-25') })),
    ...
    ...portuguesePaths.map((path) => ({ url: `${baseUrl}${path}`, lastModified: new Date(path === '/pt-br/dear-passengers-noticias/' ? '2026-09-02' : path === '/pt-br/dear-passengers-demo/' ? '2026-09-18' : path === '/pt-br/' ? '2026-07-29' : '2026-07-28') })),
    ...
    ...myanmarPaths.map((path) => ({ url: `${baseUrl}${path}`, lastModified: new Date(path === '/my/dear-passengers-news/' ? '2026-09-02' : path === '/my/dear-passengers-demo/' ? '2026-09-18' : '2026-07-30') })),
