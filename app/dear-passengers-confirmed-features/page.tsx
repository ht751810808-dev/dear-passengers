...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/dear-passengers-confirmed-features/', languages: { en: '/dear-passengers-confirmed-features/', ar: '/ar/dear-passengers-confirmed-features/', de: '/de/dear-passengers-bestaetigte-features/', tr: '/tr/dear-passengers-ozellikleri/', 'x-default': '/dear-passengers-confirmed-features/' } },
  openGraph: {
