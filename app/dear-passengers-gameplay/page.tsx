...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/dear-passengers-gameplay/', languages: { en: '/dear-passengers-gameplay/', ar: '/ar/dear-passengers-gameplay/', de: '/de/dear-passengers-gameplay/', 'x-default': '/dear-passengers-gameplay/' } },
  openGraph: {
