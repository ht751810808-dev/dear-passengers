...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/about', languages: { en: '/about/', ar: '/ar/about/', de: '/de/ueber-uns/', tr: '/tr/hakkimizda/', 'pt-BR': '/pt-br/sobre/', es: '/es/sobre/', 'my-MM': '/my/about/', 'x-default': '/about/' } },
  openGraph: {
