...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/dear-passengers-roles/', languages: { en: '/dear-passengers-roles/', ar: '/ar/dear-passengers-roles/', de: '/de/dear-passengers-rollen/', tr: '/tr/dear-passengers-rolleri/', 'pt-BR': '/pt-br/dear-passengers-funcoes/', 'x-default': '/dear-passengers-roles/' } },
  openGraph: {
