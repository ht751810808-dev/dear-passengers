...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/zh-cn/',
    languages: { en: '/', ar: '/ar/', de: '/de/', tr: '/tr/', 'pt-BR': '/pt-br/', es: '/es/', 'my-MM': '/my/', ru: '/ru/', cs: '/cs/', 'zh-CN': '/zh-cn/', 'x-default': '/' },
  },
  openGraph: {
        ...
        <section className="hero home-hero">
          ...
          <div className="container hero-content">
            ...
            <div className="hero-actions">
              ...
              <Link className="button button-ghost" href="/zh-cn/dear-passengers-steam/">核对 Steam 商店状态 →</Link>
