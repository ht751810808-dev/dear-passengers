...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/editorial-policy', languages: { en: '/editorial-policy/', ar: '/ar/editorial-policy/', de: '/de/redaktionsrichtlinien/', tr: '/tr/editorial-policy/', 'x-default': '/editorial-policy/' } },
  openGraph: {
