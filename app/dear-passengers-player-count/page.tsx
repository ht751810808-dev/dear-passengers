...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/dear-passengers-player-count', languages: { en: '/dear-passengers-player-count/', ar: '/ar/dear-passengers-player-count/', de: '/de/dear-passengers-spielerzahl/', 'zh-CN': '/zh-cn/dear-passengers-player-count/', 'x-default': '/dear-passengers-player-count/' } },
  openGraph: {
