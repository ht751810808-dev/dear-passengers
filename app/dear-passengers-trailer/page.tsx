...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/dear-passengers-trailer/', languages: { en: '/dear-passengers-trailer/', ar: '/ar/dear-passengers-trailer/', de: '/de/dear-passengers-trailer/', tr: '/tr/dear-passengers-fragman/', 'x-default': '/dear-passengers-trailer/' } },
  openGraph: {
