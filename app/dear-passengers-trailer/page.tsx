...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/dear-passengers-trailer/', languages: { en: '/dear-passengers-trailer/', ar: '/ar/dear-passengers-trailer/', de: '/de/dear-passengers-trailer/', tr: '/tr/dear-passengers-fragman/', 'pt-BR': '/pt-br/dear-passengers-trailer/', es: '/es/dear-passengers-trailer/', 'my-MM': '/my/dear-passengers-trailer/', 'x-default': '/dear-passengers-trailer/' } },
  openGraph: {
