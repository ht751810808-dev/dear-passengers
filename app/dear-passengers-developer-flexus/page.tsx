...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/dear-passengers-developer-flexus/', languages: { en: '/dear-passengers-developer-flexus/', ar: '/ar/dear-passengers-developer/', de: '/de/dear-passengers-entwickler-flexus/', tr: '/tr/dear-passengers-gelistiricisi/', 'x-default': '/dear-passengers-developer-flexus/' } },
  openGraph: {
