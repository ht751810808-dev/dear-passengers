        ...
        <div className="container article-layout">
          ...
          <div className="article-prose prose">
            ...
            <section id="verification">
              ...
              <p>DearPassengers.net — независимый неофициальный гид без связи с FLEXUS, Valve или Steam. Официальные изображения цитируются в редакционном контексте и принадлежат правообладателям. Исправление со ссылкой на источник можно отправить через <Link href="/contact">страницу контактов</Link>.</p>
            </section>
