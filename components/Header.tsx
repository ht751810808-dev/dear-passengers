...
const localizedRoutes: Array<Partial<Record<Locale, string>> & { en: string }> = [
  ...
  { en: '/dear-passengers-steam/', 'zh-CN': '/zh-cn/dear-passengers-steam/', de: '/de/dear-passengers-steam/', tr: '/tr/dear-passengers-steam/' },
  { en: '/dear-passengers-vr/', de: '/de/dear-passengers-vr/', es: '/es/dear-passengers-vr/', ru: '/ru/dear-passengers-vr/' },
