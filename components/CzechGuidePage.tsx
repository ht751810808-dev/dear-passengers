        ...
        <div className="container article-layout">
          ...
          <div className="article-prose prose">
            ...
            <section id="verification">
              ...
              <p>DearPassengers.net je nezávislý neoficiální průvodce bez spojení s FLEXUS, Valve nebo Steamem. Oficiální obrázky citujeme v redakčním kontextu a patří jejich vlastníkům. Opravu doloženou zdrojem lze poslat přes <Link href="/contact">kontaktní stránku</Link>.</p>
            </section>
